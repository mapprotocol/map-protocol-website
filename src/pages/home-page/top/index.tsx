    ...
    const cardData: Array<CardInfo> = [{
        ...
        cardContent: <Trans ns="home-page" i18nKey=
            'By leveraging the Bitcoin network’s security mechanism, MAP Protocol strengthened its network security and serves as a Bitcoin layer-2 to enable BRC-20 cross-chain and allow assets and users to from other public chains interact with the Bitcoin network via peer-to-peer cross-chain.'
                            components={{
                                link1: <Link target="_blank"
                                             href={"https://mapo.gitbook.io/docs-en/base/index_en-2/brc201"}></Link>,
                            }}/>
        ,
    }, {
        ...
        },
        {
            ...
            cardContent: <div>
                <Trans ns="home-page"
                       i18nKey="Interoperability goes beyond connecting different tokens on different chains. A truly decentralized Web3 is where assets, storage, and computing are all on-chain and interoperable. We provide the infrastructure for interoperable on-chain assets, storage, and computing."
                       components={{
                           link1: <Link target="_blank" href={"https://mapo.gitbook.io/docs-en/"}></Link>,
                       }}/>
            </div>,
        ...
        <>
            <Head>
                ...
                <meta name="description"
                      content={'MAP Protocol is an omnichain infrastructure for BTC, stablecoin, and tokenized asset swap, enabling efficient, secure, and seamless cross-chain swaps between BTC, stablecoins, and tokenised assets.'}></meta>
            </Head>
          ...
          allow="microphone">
            ...
            <div className={styles.content}>
                ...
                <div
                    className={styles.desc}> {t('MAP Protocol is a Bitcoin layer-2 for peer-to-peer cross-chain interoperability.')}</div>
            ...
            <div id={'get-start'} className={styles.getStart}>
                <div className={styles.getStartLeft}>
                    ...
                    <div
                        className={styles.getStartDesc}>{t('MAP Protocol is your gateway into the fully interoperable on-chain world. Below are the simple steps for you to quickly familiarize yourself with the ever-evolving technology.')}</div>
                </div>
