...
export default function HomePageTop() {
  ...
  const logoCard2: any[] = [
    {
      title: 'Blue White Logo #1',
      width: "234px",
      height: "47px"
    },
    {
      title: 'Blue White Logo #2',
      width: "234px",
      height: "47px"
    },
    {
      title: 'Blue White Logo #3',
      width: "234px",
      height: "80px"
    },
    {
      title: 'Blue White Logo #4',
      width: "234px",
      height: "80px"
    },
  ]
    ...
    <view>
      ...
      <div className={fade}>
        <div className={styles.mainLeft}>
          ...
          <div
            className={styles.desc}>{t('The MAP Protocol logo is displayed in the official colors and usage patterns. Do not place the logo on top of other objects and leave a reasonable amount of margin around the outside so the logo is clearly visible.')}</div>
        </div>
            ...
            <div
              ...
              <div className={styles.cardName}>{item.title}
                ...
                <div className={styles.downloadTabs}>
                  <a
                    className={styles.download}
                    href={`/logos/${index + 21}.svg`} download={`logos.svg`}>
                    SVG
                  </a>
                  <a
                    className={styles.download}
                    href={`/logos/${index + 21}.eps`} download={`logos.eps`}>
                    EPS
                  </a>
                  <a
                    className={styles.download}
                    href={`/logos/${index + 21}.png`} download={`logos.png`}>
                    PNG
                  </a>
                </div>
              </div>
