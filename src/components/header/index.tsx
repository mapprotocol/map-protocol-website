...
const Header = () => {
  ...
  useEffect(() => {
    ...
    setLanguageLabel(
      languageCards.find((item) => item.id === router.locale)?.name ||
        "English",
    );
    return () => {
      ...
      <header className={fade}>
        ...
        >
          <div className={styles.pc}>
            <Image width={150} height={40} src="/images/logo.png" alt="logo" />
          </div>
          <div className={styles.h5} style={{ transform: "translateY(-2px)" }}>
            <Image
              width={130}
              height={30}
        ...
        <div className={styles.headerRight} ref={navbarRef}>
          {tabs.map((item, index) => (
            ...
            >
              <div
                className={
                  showPanel && currentTab == item
                    ? `${styles.tabText} ${styles.tabTextShow}`
                    : styles.tabText
                }
              >
                {t(item)}
                {currentTab == item && (
                  <div
                    className={
                      showPanel
                        ? `${styles.tabPanel} ${styles.tabPanelShow}`
                        : styles.tabPanel
                    }
                  >
                    {
          ...
          <div
            className={`${styles.tab} ${styles.h5}`}
          ...
          <div className={styles.languageTab} onClick={jumpToLanguageSelect}>
            <div className={styles.tabText}>
              <LanguageIcon className={styles.languageIcon} />
              <div className={styles.pc}>{languageLabel}</div>
            </div>
          </div>
        </div>
